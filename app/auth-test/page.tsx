    ...
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="mt-8 p-6 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <ul className="text-sm text-blue-900 space-y-1 list-disc list-inside">
          ...
          <li>
            Clerk의 세션 토큰을 Supabase에 전달합니다 (2025년 네이티브 통합 방식)
          </li>
          <li>
            Clerk Dashboard에서 Supabase 통합을 활성화하고, Supabase에서 Clerk를
            Third-Party Auth Provider로 추가해야 합니다
          </li>
          <li>
            처음 로그인 시 SyncUserProvider가 Supabase users 테이블에 사용자 레코드를
            자동으로 생성합니다
          </li>
          <li>
            RLS 정책이 auth.jwt()-&gt;&gt;&apos;sub&apos;로 Clerk user ID를 확인하여,
            각 사용자는 자신의 데이터만 조회/수정할 수 있습니다
          </li>
        </ul>
      </div>
    </div>
